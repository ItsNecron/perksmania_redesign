      ...
      <div className="container mx-auto">
        <div className="relative rounded-[2.5rem] overflow-hidden min-h-[400px] flex items-center p-8 lg:p-16">
          ...
          <div className="absolute inset-0 bg-[#0f172a]">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-blue/40 rounded-full blur-[100px] animate-float"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-brand-teal/30 rounded-full blur-[100px] animate-pulse-slow"></div>
            <img 
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
              Unlock the <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal to-blue-200">VIP Lifestyle</span> for less.
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                ...
                className="px-8 py-4 bg-white text-brand-dark rounded-full font-bold text-lg hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center gap-2"
              >
          ...
          <div className="hidden lg:block absolute right-20 top-1/2 -translate-y-1/2 w-80 rotate-[-6deg] hover:rotate-0 transition-all duration-500 hover:scale-105">
             <div className="bg-white/90 backdrop-blur-xl p-4 rounded-3xl shadow-2xl border border-white/40">
                <div className="bg-gradient-to-br from-brand-blue to-brand-teal h-40 rounded-2xl mb-4 flex items-center justify-center">
                ...
                <div className="mt-6 flex justify-between items-center">
                    <div className="text-brand-dark font-bold text-xl">$14.99</div>
