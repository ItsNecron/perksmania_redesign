    ...
    <section id="perks-grid" className="py-12 bg-white scroll-mt-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-8 gap-4">
          ...
          <button 
            onClick={handleReset}
            className="hidden md:block text-brand-blue font-bold hover:underline decoration-2 underline-offset-4"
          >
            View All Perks
          </button>
        </div>
        ...
        {isEmpty ? (
          <div className="py-20 flex flex-col items-center justify-center text-center">
             ...
             <button onClick={handleReset} className="px-6 py-2 bg-brand-blue text-white rounded-lg font-bold hover:bg-brand-dark transition-colors">
                Clear Filters
             </button>
          </div>
        ) : (
        ...
        {filteredDrops.length > 0 && (
          <div className="mt-16">
              <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="px-2 py-1 bg-brand-teal/10 text-brand-teal text-xs font-bold rounded-md">
                      Ends in 12h
                  </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  {!activeCategory && !searchQuery && (
                    <div className="rounded-3xl bg-gradient-to-br from-purple-600 to-brand-blue p-8 text-white flex flex-col justify-center items-start shadow-xl">
                        ...
                        <form onSubmit={handleSubscribe} className="w-full bg-white/20 p-1 rounded-xl flex">
                            ...
                            />
                            <button type="submit" className="bg-white text-brand-blue rounded-lg px-4 py-2 text-sm font-bold shadow-md hover:bg-slate-100 transition-colors">Go</button>
                        </form>
                    </div>
                  )}
